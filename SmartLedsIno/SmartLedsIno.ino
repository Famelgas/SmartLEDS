...
void brightnessReaction() {
  ...
  else if(light > 450 && light <= 600) { // mid high brightness - 
    brightness = map(light, 400, 600, 110, 55);    
    solid(CRGB(pickedColor[0], pickedColor[1], pickedColor[2]));
  }
  else if(light > 300 && light <= 450) { // mid brightness - 
    brightness = map(light, 250, 400, 165, 110);    
    solid(CRGB(pickedColor[0], pickedColor[1], pickedColor[2]));
  }
  else if(light > 150 && light <= 300) { // mid low brightness - 
    brightness = map(light, 150, 250, 220, 165);    
    solid(CRGB(pickedColor[0], pickedColor[1], pickedColor[2]));
  }
  else { // too dark - on
    brightness = 220;
